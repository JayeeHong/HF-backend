...
import com.example.dddbackendjy.member.infrastructure.db.model.MemberMapper;
import org.springframework.stereotype.Component;

import java.util.List;

@Component
public class MemberRepository implements com.example.dddbackendjy.member.domain.spi.MemberRepository {
